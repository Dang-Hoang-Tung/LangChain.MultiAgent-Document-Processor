...
### [x] 1. Schema Implementation (schemas.py)

#### [x] Task 1.1: AnswerResponse Schema
...
### [x] 2. Agent State Implementation (agent.py, assistant.py)

#### [x] Task 2.1: AgentState Properties
...
#### [x] Task 2.2: Intent Classification Function
...
#### [x] Task 2.3: Calculation Agent Completion & Summarization Agent Completion
...
#### [x] Task 2.4: Complete the Update Memory Function
